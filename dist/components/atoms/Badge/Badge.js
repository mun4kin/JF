...
var Badge = function (_a) {
    var badgeContent = _a.badgeContent, children = _a.children, _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.variant, variant = _c === void 0 ? 'blue' : _c, _d = _a.max, max = _d === void 0 ? 99 : _d, _e = _a.position, position = _e === void 0 ? 'topRight' : _e, _f = _a.display, display = _f === void 0 ? true : _f, _g = _a.placeNear, placeNear = _g === void 0 ? false : _g;
    ...
    return (react_1.default.createElement("div", { className: "rf-badge__wrapper " + className + " " + placeNearClass, ref: wrapper },
        children,
        display &&
            react_1.default.createElement("div", { className: "rf-badge rf-badge--" + variant + " " + isDot + " " + textClass, style: coordinates }, badgeContent ? !isNaN(+badgeContent) && +badgeContent > max ? max + "+" : badgeContent : null)));
};
